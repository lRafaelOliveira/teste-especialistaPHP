<h1 class="text-2xl font-bold text-indigo-700 mb-6">Novo Assunto</h1>

<?php require __DIR__ . '/../partials/flashMessages.php'; ?>

<form action="/assuntos" method="POST" class="bg-white p-6 rounded shadow space-y-5">
    <div>
        <label class="block text-gray-700 mb-1">Descrição</label>
        <input type="text" name="descricao" required class="w-full border px-3 py-2 rounded focus:outline-none focus:ring">
    </div>
