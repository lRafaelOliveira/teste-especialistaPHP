<h1 class="text-2xl font-bold text-indigo-700 mb-6">Novo Autor</h1>

<?php require __DIR__ . '/../partials/flashMessages.php'; ?>

<form action="/autores" method="POST" class="bg-white p-6 rounded shadow space-y-5">
    <div>
        <label class="block text-gray-700 mb-1">Nome</label>
        <input type="text" name="nome" required class="w-full border px-3 py-2 rounded focus:outline-none focus:ring">
    </div>
